...
namespace InventoryTracker.Migrations
{
    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "ArchivedInventoryTransactions",
                columns: table => new
                {
                    ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArchivedInventoryTransactions", x => x.ID);
                    table.ForeignKey(
                        name: "FK_ArchivedInventoryTransactions_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_ArchivedInventoryTransactions_Products_ProductID",
                        column: x => x.ProductID,
                        principalTable: "Products",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_ArchivedInventoryTransactions_Warehouses_WarehouseId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductWarehouses", x => new { x.WarehouseId, x.ProductID });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ArchivedInventoryTransactions_ProductID",
                table: "ArchivedInventoryTransactions",
                column: "ProductID");

            migrationBuilder.CreateIndex(
                name: "IX_ArchivedInventoryTransactions_UserId",
                table: "ArchivedInventoryTransactions",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_ArchivedInventoryTransactions_WarehouseId",
                table: "ArchivedInventoryTransactions",
                column: "WarehouseId");
